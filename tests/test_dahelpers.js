...
var assert, chai, dahelpers, deepEqual, equal, h, isFalse, isTrue,
  __slice = [].slice;
...
describe('#walk()', function() {
  it('should access all properties of an object exactly once', function() {
    ...
    return deepEqual(walkArgs, [[1, 'a', ['a']], [2, 'b', ['b']], [3, 'c', ['c']], [obj.d, 'd', ['d']], [4, 'd.e', ['d', 'e']], [5, 'd.f', ['d', 'f']]]);
  });
  return it('should treat arrays as simple values', function() {
    ...
    return deepEqual(walkArgs, [[1, 'a', ['a']], [[1, 2, 3], 'b', ['b']], [null, 'c', ['c']]]);
  });
});
...
describe('#clone()', function() {
  it('should clone objects', function() {
    ...
    return deepEqual(obj.d.g, obj1.d.g);
  });
...
describe('#iter(array)', function() {
  ...
  describe('iterator.indices()', function() {
    return it('returns all array indices', function() {
      var i;
      i = h.iter([1, 2, 3, 4, 5]);
      return deepEqual(i.indices(), [0, 1, 2, 3, 4]);
    });
  });
  ...
  describe('iterator.prev()', function() {
    it('returns previous member', function() {
      var i;
      i = h.iter([1, 2, 3, 4]);
      i.next();
      i.next();
      return deepEqual(i.prev(), 1);
    });
    return it('throws an exception when iterator is at the beginning', function() {
      var i;
      i = h.iter([1, 2, 3, 4]);
      return assert.throws(function() {
        return i.prev();
  ...
  describe('iterator.each()', function() {
    return it('calls a function on each member of the array', function() {
      ...
      return deepEqual(res, [[a, 'a', 0], [a, 'b', 1], [a, 'c', 2]]);
    });
  });
  describe('iterator.map()', function() {
    return it('calls a function on each member, and returns new array', function() {
      ...
      deepEqual(res, [[a, 'a', 0], [a, 'b', 1], [a, 'c', 2]]);
      return deepEqual(a1, ['afoo', 'bfoo', 'cfoo']);
    });
  });
  describe('iterator.reduce()', function() {
    return it('reduces the array members to single value using callback', function() {
      ...
      deepEqual(res, [[a, 0, 1, 0], [a, 1, 2, 1], [a, 3, 3, 2], [a, 6, 4, 3]]);
      return equal(n, 10);
    });
  });
  describe('iterator.filter()', function() {
    it('returns only items for which callback returns true', function() {
      ...
      deepEqual(res, [[a, 1, 0], [a, 2, 1], [a, 3, 2], [a, 4, 3]]);
      return deepEqual(n, [2, 4]);
    });
  ...
  return describe('iterator.any()', function() {
    it('returns true if callback returns true for at least one member', function() {
      ...
      deepEqual(res, [[a, 1, 0], [a, 2, 1], [a, 3, 2]]);
      return isTrue(r);
    });
...
describe('#iter(object)', function() {
  ...
  describe('iterator.indices()', function() {
    return it('returns object keys', function() {
      ...
      return deepEqual(i.indices(), ['a', 'b', 'c', 'd']);
    });
  });
  describe('iterator.len()', function() {
    return it('returns length', function() {
  ...
  describe('iterator.each()', function() {
    return it('should invoke the callback on each member', function() {
      ...
      return deepEqual(res, [[o, 1, 'a'], [o, 2, 'b'], [o, 3, 'c'], [o, 4, 'd']]);
    });
  });
  describe('iterator.map()', function() {
    return it('calls a function on eachmember,and returns new object', function() {
      ...
      deepEqual(res, [[o, 1, 'a'], [o, 2, 'b'], [o, 3, 'c'], [o, 4, 'd']]);
      deepEqual(o1, {
        a: 3,
        b: 4,
        c: 5,
  ...
  describe('iterator.reduce()', function() {
    return it('reduces the object members to single value using callback', function() {
      ...
      deepEqual(res, [[o, 0, 1, 'a'], [o, 1, 2, 'b'], [o, 3, 3, 'c'], [o, 6, 4, 'd']]);
      return equal(n, 10);
    });
  });
  describe('iterator.filter()', function() {
  ...
  return describe('iterator.any()', function() {
    it('returns true if callback returns true for at least one member', function() {
      ...
      deepEqual(res, [[o, 1, 'a'], [o, 2, 'b'], [o, 3, 'c']]);
      return isTrue(r);
    });
    return it('returns false if callback never returns true', function() {
      var o, r;
